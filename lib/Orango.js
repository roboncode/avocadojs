...
const EventDispatcher = require('tangjs/lib/EventDispatcher')
const asyncForEach = require('tangjs/lib/helpers/asyncForEach')
const factory = require('./factory')
const definePrivateProperty = require('tangjs/lib/helpers/definePrivateProperty')
