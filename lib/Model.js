...
class OrangoModel extends Model {
  ...
  static importMany(docs, truncate = false) {
    this.emit(CONSTS.EVENTS.IMPORT, {
      model: this,
      data: docs
    })
    ...
    return new Promise(async resolve => {
      ...
      this.emit(CONSTS.EVENTS.IMPORTED, {
        model: this,
        data: results
      })
  ...
  static link(from, to) {
    ...
    return new Promise(async (resolve, reject) => {
      ...
      this.emit(CONSTS.EVENTS.LINKED, {
        model: this,
        data: { from, to }
      })
  ...
  static unlink(from, to) {
    ...
    this.emit(CONSTS.EVENTS.UNLINK, {
      model: this,
      data: { from, to }
    })
    ...
    return new Promise(async (resolve, reject) => {
      ...
      if (from && to) {
        ...
        this.emit(CONSTS.EVENTS.UNLINKED, {
          model: this,
          data: { from, to }
        })
