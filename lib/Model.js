...
const { ACTIONS, AQL, ERRORS, EVENTS, RETURN } = require('./consts')
...
class OrangoModel extends Model {
  ...
  static updateOne(criteria = {}, data, options = {}) {
    ...
    return this.updateMany(criteria, data, options).limit(1)
  }
  ...
  static deleteOne(criteria = {}, options = {}) {
    options.returnSingle = true
    return this.deleteMany(criteria, options).limit(1)
  }
  ...
  static findOne(criteria = {}) {
    return this.find(criteria).return(RETURN.ONE)
  }
