...
class ORM {
  ...
  populate(property, value, options = {
    merge: false
  }) {
  ...
  _compileAQLSegments() {
    ...
    if (this._action === 'find' && !this._parentDoc) {
  ...
  //     .join('')
  //   this.aqlSegments.push(
  //     this._separator + `RETURN MERGE(${this.getDocName()}, ${mergeItem})`
  //   )
  // }
  ...
  _createAQLVar() {
    // this.getDocName() = createUniqueId('doc_')
