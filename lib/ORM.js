...
const { ACTIONS, ERRORS, EVENTS, RETURN, TANG } = require('./consts')
require('colors')
...
class ORM {
  ...
  get _isCustomReturn() {
    return !(this._return === RETURN.ONE || this._return === RETURN.MANY || this._return === RETURN.MODEL || this._return === RETURN.MODELS)
  }
