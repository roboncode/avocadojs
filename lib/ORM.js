...
function isNew(returnVal) {
  return (
    returnVal === RETURN.NEW_DOC ||
    returnVal === RETURN.NEW_MODEL ||
    returnVal === RETURN.NEW_DOCS ||
    returnVal === RETURN.NEW_MODELS
  )
}

function isOld(returnVal) {
  return (
    returnVal === RETURN.OLD_DOC ||
    returnVal === RETURN.OLD_MODEL ||
    returnVal === RETURN.OLD_DOCS ||
    returnVal === RETURN.OLD_MODELS
  )
}

function isNewOld(returnVal) {
  return (
    returnVal === RETURN.NEW_OLD_DOC ||
    returnVal === RETURN.NEW_OLD_MODEL ||
    returnVal === RETURN.NEW_OLD_DOCS ||
    returnVal === RETURN.NEW_OLD_MODELS
  )
}

function isSingle(returnVal) {
  return (
    returnVal === RETURN.NEW_DOC ||
    returnVal === RETURN.OLD_DOC ||
    returnVal === RETURN.NEW_OLD_DOC ||
...
function isCustomReturn(returnVal) {
  return returnVal && !(isNew(returnVal) || isOld(returnVal) || isNewOld(returnVal))
}
...
class ORM {
  ...
  _createAQLReturn(distinct = false) {
    ...
    if (isCustomReturn(this._return)) {
    ...
    const promise = new Promise(async (resolve, reject) => {
      try {
        ...
        if (this._return) {
          ...
          // console.log('results'.bgGreen, results.length)
          ...
          if (isSingle(this._return)) {
            // console.log('IS SINGLE'.bgRed, this._return, isSingle(this._return))
