...
class ORM {
  ...
  // TODO: use this a query
  ____query(data) {
    console.log('YOU ARE HERE'.bgGreen)
  ...
  _createAQLCustom() {
    let query = this._customQuery.split('@@doc').join(this.getDocName()).split('@@collection').join(this._collection.name)
